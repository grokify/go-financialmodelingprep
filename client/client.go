...
// APIClient manages communication with the Financial Modeling Prep API API v3.0
...
type APIClient struct {
	...
	FinancialStatementsApi *FinancialStatementsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.FinancialStatementsApi = (*FinancialStatementsApiService)(&c.common)
